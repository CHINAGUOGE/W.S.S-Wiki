---
comments: true
description: DID 是什么病？本文解释解离性身份障碍与“多重人格”的关系，梳理诊断标准、常见表现、量表筛查、DID/OSDD/PDID 区别与治疗支持路径。
search:
  boost: 2.0
synonyms:
...
!!! tip "如果你是从搜索进入"
    你可能在查 **DID 是什么病**、**解离性身份障碍是不是多重人格**、**DID 和 OSDD/PDID 的区别**，或 **DID 能不能用量表测出来**。本页先给出简明答案，再展开 ICD-11、DSM-5-TR、筛查工具、鉴别诊断与治疗支持。
...
- **解离体验**：常合并[去人格化（Depersonalization）](Depersonalization.md)、[现实解体（Derealization）](Derealization.md)、躯体麻木、漂浮感、观察者视角（如"看着自己行动"）或恍惚状态。
...
- **[创伤后应激障碍（PTSD）](PTSD.md) / [复杂性创伤后应激障碍（CPTSD）](CPTSD.md)**：虽有侵入性记忆与情绪失调，但缺乏独立身份状态的控制权分配与系统性记忆断裂。
