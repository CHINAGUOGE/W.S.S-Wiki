...
!!! note "术语性质说明"
    **"后台"为系统社群术语，非 DSM-5-TR 或 ICD-11 正式诊断用语。** 本条目描述的是多意识体系统（MPS）内部的功能性状态，不应与解离性障碍的临床症状直接等同。
...
!!! info "Clinician’s Summary | 临床概要"
    **后台（Back）** 是多意识体系统（MPS）社群术语，描述成员将身体控制权交还前台、转入内在观察或休息的功能性状态。该状态非 DSM-5-TR 或 ICD-11 正式诊断用语，属系统内部精力调节与信息同步机制。后台成员通常保留不同程度的觉察能力，可通过内部沟通渠道参与监护或记录。临床对话中，"前台/后台"隐喻有助于描述解离体验差异，便于与来访者对齐讨论重点。需注意区分后台失联（系统内信息同步问题）与解离性遗忘（病理性记忆缺失），并评估切换过程中的安全风险。
