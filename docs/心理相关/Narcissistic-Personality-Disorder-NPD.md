---
comments: true
description: NPD 人格障碍是什么？本文解释自恋型人格障碍的核心特征、DSM-5-TR 与 ICD-11 要点、常见表现、鉴别诊断、共病风险与支持性治疗策略。
synonyms:
...
!!! tip "搜索导览"
    搜索 **NPD 人格障碍**、**NPD 人格** 或 **自恋型人格障碍** 时，通常需要区分三件事：普通自恋特质、造成广泛功能损害的人格障碍、以及网络语境中的道德化标签。本页只讨论临床与心理教育语境，不用于给他人贴标签。

## 常见问题（FAQ）

??? question "NPD 人格障碍是什么？"
    NPD 是 **Narcissistic Personality Disorder** 的缩写，中文为 **自恋型人格障碍**。它不是单纯“爱自己”或“自信”，而是长期存在的夸大、特权感、赞赏需求、同理心困难与人际功能损害模式。

??? question "自恋型人格障碍和自恋特质有什么区别？"
    很多人都可能在某些场景中表现出自恋特质，例如重视面子、想被认可或对批评敏感。只有当这些模式长期、跨场景存在，并造成显著人际、职业或情绪功能损害时，才需要考虑人格障碍层面的评估。

??? question "可以用网上描述判断一个人是 NPD 吗？"
    不建议。NPD 诊断需要专业评估、长期模式观察和鉴别诊断。网络描述可用于理解互动困境和边界设置，但不应直接替代临床诊断。
