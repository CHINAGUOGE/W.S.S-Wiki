...
??? question "内在家庭系统疗法是什么？"
    内在家庭系统疗法（IFS）是一种把人的内在体验理解为“由多个部分组成”的治疗模型。它认为焦虑、羞耻、批评、自我保护、受伤感等体验，往往对应不同的“部分”，治疗的重点不是消灭这些部分，而是理解它们在保护什么。

??? question "IFS 的核心思想是什么？"
    IFS 的核心是：**所有部分都有某种保护意图**，哪怕行为看起来激烈或破坏性；同时，每个人都具有可以带着平静、好奇和慈悲来领导系统的 **Self（核心自我）**。治疗目标是让 Self 重新取得领导，而不是让某个“坏部分”被压下去。

??? question "IFS 和 DID/OSDD 有什么关系？"
    IFS 不是 DID 或 OSDD 的同义词，也不能替代正式诊断。但它对有明显内部冲突、部分化体验或多意识体结构的人来说通常比较友好，因为它本来就承认“内在不是单一声音”。对于复杂创伤和解离个体，IFS 更适合放在创伤知情、分阶段的框架里使用。
