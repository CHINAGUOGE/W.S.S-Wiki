...
!!! note "研究支持"
    DID相关笔迹/镜像书写个案与取证研究较早即有报道,提示状态间运动程序/书写动力学可变。[^lerner2017][^somer1997]

### 5. 生理-心理反应(研究向)

- **心率/皮电/惊吓反应**:在特定任务或脚本引导下的生理指标差异
- **痛觉/情绪调节脑区激活差异**:fMRI等神经影像研究观察到的脑区活动模式变化

!!! note "研究支持"
    多项 fMRI/心理生理学研究显示不同身份状态呈可复测的差异(支持(状态依赖）思路,不是民间所谓(伪装）即可复制)。[^reinders2003][^reinders2012]
...
ISSTD 成人与儿童青少年指南建议系统化追踪切换与诱因、建立安全计划与沟通方案;这为(记录个体化识别线索）提供了临床上的合理性。指南并未使用(锚点）一词,但实务指引与本概念一致。[^isstd2011][^isstd2004]

### 生理/脑影像

Reinders 团队等在脚本驱动意象范式下,发现不同身份状态在自主神经/脑区激活上存在可区分模式,支持(状态-特异性线索）在科学层面具可测量性。[^reinders2003][^reinders2012][^reinders2016]

### 行为书写/语音

个案与小样本研究显示笔迹/镜像书写/语音可随身份状态改变;但总体证据等级仍偏低,不宜作司法/医学上的单证。[^domin2018][^lerner2017][^somer1997]

### 数字身份学

Emoji 与书写风格在一般人群中具有稳定个体差异并能承载身份表演,因此在多意识体数字交流中合理用作(辅助锚点）。注意:这类指标指向(是谁在说话）,非(是否 DID）。[^marko2023][^kejriwal2021]
...
!!! warning "使用前必读"
    在实际应用锚点识别前,必须充分了解以下风险与伦理边界。

### 取证误用风险

笔迹/语音等可被刻意模仿或伪装;司法场景需多源证据与专家评估。[^somer1997]

### 隐私与安全

公开锚点可能让恶意者(顺藤摸瓜）识别成员;建议最小可用披露原则。
