...
对于经历创伤或长期应激的个体（详见 [创伤（Trauma）](Trauma.md)），定向力波动常与安全感丧失或被触发的再体验相连，需要结合创伤史评估。多意识系统在强烈触发后亦可能短暂出现定向混乱，应区分谵妄、解离及系统内部切换造成的体验差异。
...
- 将定向障碍列为谵妄（6D70）与部分神经认知障碍的核心临床表现，特征包含意识水平波动、定向力与注意受损。[^who2023]
...
- 谵妄的诊断标准强调注意力与觉醒受损，并伴随额外的认知障碍，如记忆缺失或定向障碍。[^apa2022]
...
- **时间定向障碍** : 无法正确指出日期、星期、季节或日夜顺序；时间定向通常最早受损。[^inouye2014]
...
2. **前后台交接协议** ：建立“下班记录”或内部留言板，交代目前日期、进行中的任务与待处理事项，降低突发切换后的迷失（参照 ISSTD 稳定化阶段的工具化交接）。[^isstd2011]
3. **安全监测** ：若时间空窗伴随危险行为或外部失联，应预设紧急联络人与医疗信息卡，同时与治疗师讨论阶段化稳定化方案。[^brand2014][^isstd2011]

## 病理机制与背景

- **创伤触发** : 复杂创伤史或持续威胁体验可导致自我保护性的解离反应，使个体暂时脱离当下情境而产生定向混乱。[^apa2022]
- **结构性解离视角** : 多意识系统在身份切换时，若信息交接不足，容易暂时失去对时间地点的掌握，需要内部提示机制支援。
- **神经生物学** : 压力相关的丘脑—皮质网络与海马功能受损，会影响情境记忆整合与时间定向。[^wang2020]

## 流行病学与病程

- 在老年住院人群中，谵妄的发生率可达 15%–30%，定向障碍是最常见的临床信号之一。[^inouye2014]
...
- **神经退行性疾病** : 阿尔茨海默病导致的定向障碍进展缓慢，需结合神经心理测试与影像检查。[^wang2020]
