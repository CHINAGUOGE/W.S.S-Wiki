...
??? question "解离性失忆是什么？"
    解离性失忆是指一个人在没有脑损伤、醉酒或神经退行性疾病等更好解释的情况下，**无法回忆重要自传信息**，而这些缺失常常与创伤或高压事件有关。很多人会把它理解成“我明明经历过，但那一段像被挖空了”。

??? question "解离性失忆和普通健忘有什么区别？"
    普通健忘更多是零散模糊、回忆困难；解离性失忆则可能出现 **整段时间、整类信息或创伤核心内容成块缺失**。它通常超出“最近太累了所以忘了”的程度，而且常伴随明显困惑、失控感或功能影响。

??? question "解离性失忆会不会把整个人生都忘掉？"
    少数情况下会出现范围很大的遗忘，但更常见的还是 **局灶性** 或 **选择性** 缺失，也就是集中围绕某个阶段、某类事件或某段创伤经历。完全广泛性的身份史遗忘相对少见，需要仔细做医学和心理学鉴别。

??? question "记忆能恢复吗？"
    有些记忆会在安全环境、稳定支持和治疗过程中逐渐恢复，也有些会长期模糊或留下空白。临床上更重要的是先处理安全、功能和创伤反应，而不是急于“把记忆硬挖出来”，因为强行追忆可能增加风险。
...
- **情绪与躯体反应**:头痛、胃肠不适、解离性麻木、[去人格化（Depersonalization）](Depersonalization.md)、[现实解体（Derealization）](Derealization.md)等伴随症状常见。
