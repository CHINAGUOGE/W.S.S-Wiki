...
??? question "现实检验是什么？"
    现实检验是指一个人能否把“我感觉到的”“我想到的”与“外部事实上发生的”区分开来。很多人会把它搜索成“现实认知检定”或“现实检验能力”，核心都在于判断一个想法是否有足够证据支持，而不是只凭情绪下结论。

??? question "现实检验怎么做？"
    最常见的方法是先停下来，把事实、推测和情绪拆开写，再去找支持与反驳证据。例如：现在发生了什么、我怎么解释它、还有没有别的解释、我能用什么方式核对。必要时可以找可信任的人做外部校准，但目标是逐步提升自己的辨识能力，而不是无限求证。

??? question "现实检验和接地有什么区别？"
    [接地（Grounding）](Grounding.md)更偏向把你从失控或脱节状态里拉回当下；现实检验则更偏向在回到当下之后，进一步判断“我现在的理解是否贴近事实”。前者偏稳定，后者偏评估，两者经常配合使用。
