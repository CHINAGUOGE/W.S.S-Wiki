...
若在自我观察中常分不清“这是单点触发还是最近一直在累积”，可参见[触发因素与压力累积](Trigger-vs-Stress-Accumulation.md)。
...
若希望进一步区分冻结与讨好的具体体验、关系代价与当下应对，可参见[冻结与讨好反应](Freeze-Fawn-Responses.md)。
...
- **高应激情境** 可能触发或加剧解离症状（如[去人格化（Depersonalization）](Depersonalization.md)、[去现实化（Derealization）](Derealization.md)、[非我感（Not-me Feeling）](Not-Me-Feeling.md)、记忆断片）；
...
- [**创伤疗愈导览**](../contributing/)：稳定化-处理-整合的阶段模型。
