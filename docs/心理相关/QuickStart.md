...
!!! warning "紧急提醒"
    ...
    参见《[危机与支援资源（Crisis & Support Resources）](../心理相关/Crisis-And-Support-Resources.md)》获取 24 小时热线、城市支援与自助安全计划模板。
...
=== "参与贡献"
    ...
    1. 新词条放在 `docs/../心理相关/`，不得创建子目录，使用模板 `docs/TEMPLATE_ENTRY.md`。
...
=== "新手（0–4 周）"
    ...
    4. 开始练习 [接地](../心理相关/Grounding.md) 等基础技巧。
...
??? question "我不确定自己是什么类型的系统？"
    ...
    若在 Tulpa/自创型意识体与解离性系统之间犹豫，可参考 [Tulpa 判定标准与系统类型指引](../心理相关/Tulpa-Classification-Guide-Ise.md) 了解常见情境与风险提醒。
    记住：分类不是目的，理解自己与保障安全更重要。

??? question "我需要诊断吗？"
    取决于你的需求：

    - 症状影响生活功能时，建议就医评估（如 [DID](../心理相关/DID.md)、[OSDD](../心理相关/OSDD.md)、[PTSD](../心理相关/PTSD.md)）。
    - 若仅为自我理解，未必需要正式诊断。
