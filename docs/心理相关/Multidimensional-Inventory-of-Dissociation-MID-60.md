...
!!! info "速览 Clinician's Summary"
    ...
    **解读边界**:MID‑60 属于 **筛查级工具**,不能替代正式诊断。分数需结合具体困扰与功能受损情况讨论;高分不等同诊断,低分亦不排除个别情境下的显著困扰。进一步评估需使用诊断级工具。补充：对于已经确认是多意识体体系（包括但不限于did，osdd等）的用户，该量表会有部分失真 （其中有部分问题就是您的日常体验），需结合自身实际情况进行多方面评估
