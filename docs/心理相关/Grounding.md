...
??? question "Grounding 是什么？"
    Grounding 通常译为 **接地**，也常被称为接地技巧、接地练习或稳定技巧。它不是神秘训练，而是一组把注意力重新带回“此时此地”的方法，常用于闪回、恐慌、过度唤醒、解离和强烈情绪升高时的短时稳定。

??? question "接地什么时候用？"
    当你出现“脑子像被拉走”“像不在现场”“快要被情绪淹没”“身体开始发抖或发麻”“创伤画面往上涌”等情况时，就适合先做接地。它尤其适合搭配[闪回（Flashback）](Flashback.md)、[现实检验（Reality Testing）](Reality-Testing.md)与[危机指南](Crisis-Response.md)一起使用。

??? question "接地和正念有什么区别？"
    两者都关注当下，但目标不同。[正念（Mindfulness）](Mindfulness.md)更强调持续觉察与非评判态度；接地则更偏向 **应急稳定**，重点是尽快确认“我现在在哪里、周围是否安全、身体是否在场”。在创伤反应很强的时候，接地通常比长时间静坐更容易上手。

??? question "为什么接地对闪回有帮助？"
    闪回会让人像被拖回过去，接地则通过视觉、触觉、呼吸、温度和动作，把注意力重新固定到当前环境。它不能抹掉创伤记忆，但能降低“创伤正在重演”的沉浸感，帮助个体重新建立时间感、空间感和安全感。
