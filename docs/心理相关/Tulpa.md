...
??? question "Tulpa 是什么？"
    Tulpa 常译作 **图帕** 或 **托帕**，指通过长期、刻意的想象与互动练习培育出的内在意识同伴。很多人会直接搜索“tulpa 是什么”，最简要的理解是：它属于网络社群中的创造型意识体验，而不是临床诊断名词。

??? question "如何创造 Tulpa？"
    最常见的路径包括人格设定、持续[塑造（Forcing）](Forcing.md)、可视化、对话练习与感官细节赋予。它通常不是“一两天就能完成”的事，而是一个持续数周到数月的练习过程。更细的步骤、风险与节奏建议可直接看 [Tulpa 完全创造指南](Tulpa-Guide-0.md) 及其分册。

??? question "Tulpa 和 DID 一样吗？"
