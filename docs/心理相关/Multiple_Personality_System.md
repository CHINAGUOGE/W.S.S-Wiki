...
- **创伤关联型**：与[解离性障碍](Dissociative-Disorders.md)重叠，如 [DID](DID.md)/[OSDD](OSDD.md)，形成机制常与长期创伤、依恋破裂相关。
- **创造/练习型**：通过可视化、冥想或脚本练习有意培育的多意识体验，例如[图帕（Tulpa）](Tulpa.md)、[傀儡（Servitor）](Servitor.md)、[系魂（Soulbond）](Soulbond.md) 等；通常记忆共享度更高、功能性或陪伴性诉求更突出。
- **灵性与文化型**：根植于宗教/灵性实践或文化框架（如附身仪式、守护灵等），是否认同为“系统”由当事人自主决定。

本词条覆盖上述多种路径，强调尊重系统自我定义与体验差异，避免将“多意识体”单一化为创伤型或临床诊断。
