...
用法：
  python3 tools/check_tags.py docs/../心理相关/
  python3 tools/check_tags.py docs/../心理相关/DID.md
  python3 tools/check_tags.py --verbose docs/../心理相关/
"""
...
def main(argv: List[str]) -> int:
    ...
    parser.add_argument(
        ...
        nargs="*",
        type=Path,
        default=[Path("docs/../心理相关/")],
        help="要检查的目录或文件（默认：docs/../心理相关/）",
    )
    parser.add_argument(
        "--verbose",
        action="store_true",
    ...
    for md in targets:
        # 仅对 docs/../心理相关/ 下的词条强制校验（若传入单文件也允许）
        in_entries = False
        try:
